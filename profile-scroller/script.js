...
function* createPeopleIterator() {
   let index = 0; 
   // keep the interator continue to iterate without stop 
  while (true) {
     // keep the index within a range in the people array
...
// make the initial 'click' to get the first person
nextBtn.click();
